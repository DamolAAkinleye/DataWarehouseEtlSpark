...
//      )
    ...
    var sqlStr =
      s"""
        ...
        |if(b.area is null,'',b.area) as ${columns.allColumns(5)},
        |a.province as ${columns.allColumns(6)},
        |if(b.city is null or b.city='',a.city,b.city) as ${columns.allColumns(7)},
        |if(a.district is null,'',a.district) as ${columns.allColumns(8)},
        |if(b.city_level is null,'',b.city_level) as ${columns.allColumns(9)},
